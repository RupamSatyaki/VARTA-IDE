...
const SEVERITY_ICON: Record<string, React.ReactNode> = {
  error: (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="text-[#f44747] shrink-0">
      <path d="M8 1a7 7 0 100 14A7 7 0 008 1zm0 1a6 6 0 110 12A6 6 0 018 2zm-.5 3v5h1V6h-1zm0 6v1h1v-1h-1z"/>
    </svg>
  ),
  warning: (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="text-[#ff8c00] shrink-0">
  ...
  info: (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="text-[#569cd6] shrink-0">
      <path d="M8 1a7 7 0 100 14A7 7 0 008 1zm0 1a6 6 0 110 12A6 6 0 018 2zm-.5 3v1h1V6h-1zm0 2v5h1V8h-1z"/>
    </svg>
  ),
  hint: (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="text-[#4ec9b0] shrink-0">
      <path d="M8 1a7 7 0 100 14A7 7 0 008 1zm0 1a6 6 0 110 12A6 6 0 018 2zm-.5 3v1h1V6h-1zm0 2v5h1V8h-1z"/>
    </svg>
  ),
}
