    ...
    <div className="px-2 py-2 border-b border-[#333333]">
      <div className="relative">
        <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor"
          className="absolute left-2 top-1/2 -translate-y-1/2 text-[#6e6e6e] pointer-events-none">
        ...
        <input
          ...
          className="w-full h-7 pl-7 pr-2 text-xs bg-[#3c3c3c] text-[#d4d4d4] border border-[#3c3c3c] focus:border-[#569cd6] rounded outline-none placeholder:text-[#6e6e6e]"
        />
      </div>
    </div>
  )
