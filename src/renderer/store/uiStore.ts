...
export interface UIActions {
  ...
  setSecondarySidebarVisible:(v: boolean) => void
...
export const useUIStore = create<UIState & UIActions>()(
  immer((set) => ({
    ...
    toggleSecondarySidebar:   ()  => set((s) => { s.secondarySidebarVisible = !s.secondarySidebarVisible }),
    setSecondarySidebarVisible:(v) => set((s) => { s.secondarySidebarVisible = v }),
